...
def merge_files(file1_data, file2_data):
    ...
    for code in all_codes:
        if code in dict1 and code in dict2:
            ...
            merged_obj = clean_object(dict1[code])
        else:
            merged_obj = clean_object(dict2[code])

        if 'dataEndYear' not in merged_obj:
            merged_obj['dataEndYear'] = None

        if 'location_description' not in merged_obj:
            merged_obj['location_description'] = "N/A"
